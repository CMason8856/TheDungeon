...
public class Panel extends JPanel{
    ...
    static void keyPressed(KeyEvent ke) {
        int i = ke.getKeyCode();
        switch(i){
            case KeyEvent.VK_W: if(!collisionDetection(-mi)){manipulateY(-mi);}; break;
            case KeyEvent.VK_A: if(!collisionDetection(-mi)){manipulateX(-mi);}; break;
            case KeyEvent.VK_S: if(!collisionDetection(mi)){manipulateY(mi);}; break;
            case KeyEvent.VK_D: if(!collisionDetection(mi)){manipulateX(mi);}; break;
